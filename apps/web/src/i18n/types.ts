...
export interface Dict {
  ...
  'workspaceNav.title': string;
  'workspaceNav.fallbackName': string;
  'workspaceNav.switchAria': string;
  ...
  'workspaceInvite.expiredMessage': string;
  'workspaceInvite.usedTitle': string;
  'workspaceInvite.usedMessage': string;
  'workspaceInvite.notFoundTitle': string;
  'workspaceInvite.returnAction': string;
  'workspaceInvite.openWorkspaceAction': string;
  'workspaceInvite.joinedSwitchFailedTitle': string;
  'workspaceInvite.joinedSwitchFailedMessage': string;
  'workspaceInvite.joiningTitle': string;
  'workspaceInvite.joiningMessage': string;
  'workspaceInvite.joinedTitle': string;
  'workspaceInvite.joinedMessage': string;
  'workspaceInvite.alreadyJoinedTitle': string;
  'workspaceInvite.alreadyJoinedMessage': string;
  'workspaceTabs.tabsAria': string;
  'workspaceTabs.openWorkspaces': string;
  'workspaceTabs.newTab': string;
  'workspaceTabs.searchTabs': string;
  'workspaceTabs.openTabs': string;
  'workspaceTabs.noTabsFound': string;
  'workspaceTabs.startNewProject': string;
  'workspaceSettings.roleOwner': string;
  'workspaceSettings.roleAdmin': string;
  'workspaceSettings.roleMember': string;
  'workspaceSettings.loadingAccess': string;
  'workspaceSettings.capabilityPersonal': string;
  'workspaceSettings.capabilityOwner': string;
  'workspaceSettings.capabilityAdmin': string;
  'workspaceSettings.capabilityMember': string;
  'workspaceSettings.capabilityNoAccess': string;
  'workspaceSettings.adminOwnerRequired': string;
  'workspaceSettings.ownerRequired': string;
  'workspaceSettings.viewerLinksManagerRequired': string;
  'workspaceSettings.accessAria': string;
  'workspaceSettings.loadStatusAria': string;
  'workspaceSettings.detailsUnavailable': string;
  'workspaceSettings.retry': string;
  'workspaceSettings.statusAria': string;
  'workspaceSettings.statusMembers': string;
  'workspaceSettings.statusProjects': string;
  'workspaceSettings.statusAutomations': string;
  'workspaceSettings.statusPendingInvites': string;
  'workspaceSettings.statusViewerLinks': string;
  'workspaceSettings.noOwnerLoaded': string;
  'workspaceSettings.detailsTitle': string;
  'workspaceSettings.detailsTeamBody': string;
  'workspaceSettings.detailsPersonalBody': string;
  'workspaceSettings.personalNameFixed': string;
  'workspaceSettings.workspaceNamePlaceholder': string;
  'workspaceSettings.saving': string;
  'workspaceSettings.createTitle': string;
  'workspaceSettings.createBody': string;
  'workspaceSettings.creating': string;
  'workspaceSettings.membersTitle': string;
  'workspaceSettings.membersBody': string;
  'workspaceSettings.loadingMembers': string;
  'workspaceSettings.ownerRoleLocked': string;
  'workspaceSettings.transferAssetsAria': string;
  'workspaceSettings.assetsToMember': string;
  'workspaceSettings.removing': string;
  'workspaceSettings.remove': string;
  'workspaceSettings.askAdminChangeAccess': string;
  'workspaceSettings.ownershipTitle': string;
  'workspaceSettings.ownershipBody': string;
  'workspaceSettings.personalOwnershipLocked': string;
  'workspaceSettings.inviteBeforeTransferOwner': string;
  'workspaceSettings.transferring': string;
  'workspaceSettings.transferOwner': string;
  'workspaceSettings.invitesTitle': string;
  'workspaceSettings.invitesBody': string;
  'workspaceSettings.personalNoInvites': string;
  'workspaceSettings.inviteRoleAria': string;
  'workspaceSettings.inviteExpiryAria': string;
  'workspaceSettings.dayOption': string;
  'workspaceSettings.daysOption': string;
  'workspaceSettings.creatingInvite': string;
  'workspaceSettings.createInvite': string;
  'workspaceSettings.hideHistory': string;
  'workspaceSettings.showHistory': string;
  'workspaceSettings.invitesManagerOnly': string;
  'workspaceSettings.noInvites': string;
  'workspaceSettings.noActiveInvites': string;
  'workspaceSettings.copy': string;
  'workspaceSettings.revoking': string;
  'workspaceSettings.revoke': string;
  'workspaceSettings.viewerLinksTitle': string;
  'workspaceSettings.viewerLinksBody': string;
  'workspaceSettings.viewerLinksManagerOnly': string;
  'workspaceSettings.noViewerLinks': string;
  'workspaceSettings.projectsTitle': string;
  'workspaceSettings.projectsBody': string;
  'workspaceSettings.noProjects': string;
  'workspaceSettings.ownedBy': string;
  'workspaceSettings.createdBy': string;
  'workspaceSettings.createdAt': string;
  'workspaceSettings.expiresAt': string;
  'workspaceSettings.revokedAt': string;
  'workspaceSettings.acceptedBy': string;
  'workspaceSettings.transferProjectOwnerAria': string;
  'workspaceSettings.ownerOption': string;
  'workspaceSettings.transfer': string;
  'workspaceSettings.moveProjectAria': string;
  'workspaceSettings.moveToPlaceholder': string;
  'workspaceSettings.moving': string;
  'workspaceSettings.move': string;
  'workspaceSettings.lifecycleTitle': string;
  'workspaceSettings.lifecycleBody': string;
  'workspaceSettings.personalCannotLeaveDelete': string;
  'workspaceSettings.transferBeforeLeaving': string;
  'workspaceSettings.moveProjectsBeforeDelete': string;
  'workspaceSettings.deleteAutomationsBeforeDelete': string;
  'workspaceSettings.leaving': string;
  'workspaceSettings.leave': string;
  'workspaceSettings.deleting': string;
  'workspaceSettings.activityTitle': string;
  'workspaceSettings.activityBody': string;
  'workspaceSettings.noActivity': string;
  'workspaceSettings.detailsLoadError': string;
  'workspaceSettings.viewerLinksLoadError': string;
  'workspaceSettings.invitesLoadError': string;
  'workspaceSettings.workspaceCreatedNotice': string;
  'workspaceSettings.workspaceRenamedNotice': string;
  'workspaceSettings.leaveConfirm': string;
  'workspaceSettings.leftNotice': string;
  'workspaceSettings.deleteConfirm': string;
  'workspaceSettings.deletedNotice': string;
  'workspaceSettings.adminInviteConfirm': string;
  'workspaceSettings.inviteCreateFailed': string;
  'workspaceSettings.inviteCopied': string;
  'workspaceSettings.roleChangeConfirm': string;
  'workspaceSettings.transferOwnershipConfirm': string;
  'workspaceSettings.ownershipTransferredNotice': string;
  'workspaceSettings.chooseTransferTargetNotice': string;
  'workspaceSettings.thisWorkspace': string;
  'workspaceSettings.removeMemberConfirm': string;
  'workspaceSettings.revokeInviteConfirm': string;
  'workspaceSettings.onlyPendingInviteCopy': string;
  'workspaceSettings.noInviteLink': string;
  'workspaceSettings.revokeViewerLinkConfirm': string;
  'workspaceSettings.viewerLinkRevokedNotice': string;
  'workspaceSettings.viewerLinkCopied': string;
  'workspaceSettings.noViewerLink': string;
  'workspaceSettings.moveProjectConfirm': string;
  'workspaceSettings.projectMovedNotice': string;
  'workspaceSettings.transferProjectOwnerConfirm': string;
  'workspaceSettings.projectOwnerTransferredNotice': string;
  'workspaceSettings.you': string;
  'workspaceSettings.viewerRole': string;
  'workspaceSettings.inviteLink': string;
  'workspaceSettings.inviteAccepted': string;
  'workspaceSettings.inviteRevoked': string;
  'workspaceSettings.inviteExpired': string;
  'workspaceSettings.ownsAssets': string;
  'workspaceSettings.joinedAt': string;
  'workspaceSettings.joinList': string;
  'workspaceSettings.projectSingular': string;
  'workspaceSettings.projectPlural': string;
  'workspaceSettings.routineSingular': string;
  'workspaceSettings.routinePlural': string;
  'workspaceSettings.viewerLinkSingular': string;
  'workspaceSettings.viewerLinkPlural': string;
  'workspaceSettings.inviteSingular': string;
  'workspaceSettings.invitePlural': string;
  'workspaceSettings.deploymentSingular': string;
  'workspaceSettings.deploymentPlural': string;
  'workspaceSettings.memberRecordSingular': string;
  'workspaceSettings.memberRecordPlural': string;
  'workspaceSettings.pendingInviteSingular': string;
  'workspaceSettings.pendingInvitePlural': string;
  'workspaceSettings.activityHistory': string;
  'workspaceSettings.memberFallback': string;
  'workspaceSettings.projectFallback': string;
  'workspaceSettings.artifactFallback': string;
  'workspaceSettings.newNameFallback': string;
  'workspaceSettings.leaveImpactNoAssets': string;
  'workspaceSettings.leaveImpact': string;
  'workspaceSettings.leaveImpactWithRecipient': string;
  'workspaceSettings.removeMemberImpactNoAssets': string;
  'workspaceSettings.removeMemberImpact': string;
  'workspaceSettings.roleChangeToAdminImpact': string;
  'workspaceSettings.roleChangeToMemberImpact': string;
  'workspaceSettings.adminInviteImpact': string;
  'workspaceSettings.adminInviteImpactWithExpiry': string;
  'workspaceSettings.transferWorkspaceOwnerImpact': string;
  'workspaceSettings.moveProjectImpact': string;
  'workspaceSettings.transferProjectOwnerImpact': string;
  'workspaceSettings.revokeInviteImpact': string;
  'workspaceSettings.revokeViewerLinkImpact': string;
  'workspaceSettings.revokeViewerLinkImpactWithArtifact': string;
  'workspaceSettings.deleteWorkspaceImpact': string;
  'workspaceSettings.cleanupRevoked': string;
  'workspaceSettings.cleanupTransferred': string;
  'workspaceSettings.cleanupTransferredTo': string;
  'workspaceSettings.cleanupStillOwned': string;
  'workspaceSettings.activityWorkspaceCreated': string;
  'workspaceSettings.activityWorkspaceRenamed': string;
  'workspaceSettings.activityMemberLeft': string;
  'workspaceSettings.activityMemberRemoved': string;
  'workspaceSettings.activityRoleUpdated': string;
  'workspaceSettings.activityOwnerTransferred': string;
  'workspaceSettings.activityInviteCreated': string;
  'workspaceSettings.activityInviteRevoked': string;
  'workspaceSettings.activityInviteAccepted': string;
  'workspaceSettings.activityProjectCreated': string;
  'workspaceSettings.activityProjectCreatedFrom': string;
  'workspaceSettings.activityProjectDeleted': string;
  'workspaceSettings.activityProjectImported': string;
  'workspaceSettings.activityProjectImportedFrom': string;
  'workspaceSettings.activityProjectMoved': string;
  'workspaceSettings.activityProjectMovedWith': string;
  'workspaceSettings.activityProjectOwnerTransferred': string;
  'workspaceSettings.activityRoutineCreated': string;
  'workspaceSettings.activityRoutineUpdated': string;
  'workspaceSettings.activityRoutineDeleted': string;
  'workspaceSettings.activityRoutineOwnerTransferred': string;
  'workspaceSettings.activityRoutineRun': string;
  'workspaceSettings.activityShareCreated': string;
  'workspaceSettings.activityShareRevoked': string;
  'workspaceSettings.activityShareRevokedProjectDeleted': string;
  'workspaceSettings.activityShareRevokedArtifactDeleted': string;
