...
export const esES: Dict = {
  ...
  'workspaceLoad.kicker': "ESPACIOS DE TRABAJO",
  'workspaceLoad.loadFailedTitle': "No se pudieron cargar los espacios de trabajo",
  'workspaceLoad.refreshFailedTitle': "No se pudieron actualizar los espacios de trabajo.",
  'workspaceLoad.retry': "Reintentar",
  'workspaceLoad.retrying': "Reintentando...",
  'workspaceLoad.personalFallback': "Espacio de trabajo personal",
  'workspaceLoad.defaultError': "No se pudieron cargar los espacios de trabajo.",
  'workspaceLoad.projectsError': "No se pudieron cargar los proyectos del espacio de trabajo.",
  'workspaceLoad.emptyListError': "La respuesta de la lista de espacios de trabajo no incluía ningún espacio.",
  'workspaceLoad.inviteSwitchError': "No se pudo cambiar al espacio de trabajo invitado.",
