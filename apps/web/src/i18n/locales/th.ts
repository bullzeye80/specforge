...
export const th: Dict = {
  ...
  'workspaceLoad.kicker': "พื้นที่ทำงาน",
  'workspaceLoad.loadFailedTitle': "ไม่สามารถโหลดพื้นที่ทำงานได้",
  'workspaceLoad.refreshFailedTitle': "ไม่สามารถรีเฟรชพื้นที่ทำงานได้",
  'workspaceLoad.retry': "ลองอีกครั้ง",
  'workspaceLoad.retrying': "กำลังลองอีกครั้ง...",
  'workspaceLoad.personalFallback': "พื้นที่ทำงานส่วนตัว",
  'workspaceLoad.defaultError': "ไม่สามารถโหลดพื้นที่ทำงานได้",
  'workspaceLoad.projectsError': "ไม่สามารถโหลดโปรเจกต์ในพื้นที่ทำงานได้",
  'workspaceLoad.emptyListError': "การตอบกลับรายการพื้นที่ทำงานไม่มีพื้นที่ทำงานใด ๆ",
  'workspaceLoad.inviteSwitchError': "ไม่สามารถสลับไปยังพื้นที่ทำงานที่ได้รับเชิญได้",
