...
export const de: Dict = {
  ...
  'workspaceLoad.kicker': "ARBEITSBEREICHE",
  'workspaceLoad.loadFailedTitle': "Arbeitsbereiche konnten nicht geladen werden",
  'workspaceLoad.refreshFailedTitle': "Arbeitsbereiche konnten nicht aktualisiert werden.",
  'workspaceLoad.retry': "Erneut versuchen",
  'workspaceLoad.retrying': "Erneuter Versuch...",
  'workspaceLoad.personalFallback': "Persönlicher Arbeitsbereich",
  'workspaceLoad.defaultError': "Arbeitsbereiche konnten nicht geladen werden.",
  'workspaceLoad.projectsError': "Arbeitsbereich-Projekte konnten nicht geladen werden.",
  'workspaceLoad.emptyListError': "Die Arbeitsbereichsliste enthielt keine Arbeitsbereiche.",
  'workspaceLoad.inviteSwitchError': "Zum eingeladenen Arbeitsbereich konnte nicht gewechselt werden.",
