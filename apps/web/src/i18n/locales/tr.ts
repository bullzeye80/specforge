...
export const tr: Dict = {
  ...
  'workspaceLoad.kicker': "ÇALIŞMA ALANLARI",
  'workspaceLoad.loadFailedTitle': "Çalışma alanları yüklenemedi",
  'workspaceLoad.refreshFailedTitle': "Çalışma alanları yenilenemedi.",
  'workspaceLoad.retry': "Yeniden dene",
  'workspaceLoad.retrying': "Yeniden deneniyor...",
  'workspaceLoad.personalFallback': "Kişisel çalışma alanı",
  'workspaceLoad.defaultError': "Çalışma alanları yüklenemedi.",
  'workspaceLoad.projectsError': "Çalışma alanı projeleri yüklenemedi.",
  'workspaceLoad.emptyListError': "Çalışma alanı listesi yanıtında hiçbir çalışma alanı yoktu.",
  'workspaceLoad.inviteSwitchError': "Davet edilen çalışma alanına geçilemedi.",
