...
export const fr: Dict = {
  ...
  'workspaceLoad.kicker': "ESPACES DE TRAVAIL",
  'workspaceLoad.loadFailedTitle': "Impossible de charger les espaces de travail",
  'workspaceLoad.refreshFailedTitle': "Impossible d'actualiser les espaces de travail.",
  'workspaceLoad.retry': "Réessayer",
  'workspaceLoad.retrying': "Nouvelle tentative...",
  'workspaceLoad.personalFallback': "Espace de travail personnel",
  'workspaceLoad.defaultError': "Impossible de charger les espaces de travail.",
  'workspaceLoad.projectsError': "Impossible de charger les projets de l'espace de travail.",
  'workspaceLoad.emptyListError': "La réponse de liste des espaces de travail ne contenait aucun espace.",
  'workspaceLoad.inviteSwitchError': "Impossible de basculer vers l'espace de travail invité.",
