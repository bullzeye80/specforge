...
export const pl: Dict = {
  ...
  'workspaceLoad.kicker': "OBSZARY ROBOCZE",
  'workspaceLoad.loadFailedTitle': "Nie można wczytać obszarów roboczych",
  'workspaceLoad.refreshFailedTitle': "Nie można odświeżyć obszarów roboczych.",
  'workspaceLoad.retry': "Spróbuj ponownie",
  'workspaceLoad.retrying': "Ponawianie próby...",
  'workspaceLoad.personalFallback': "Osobisty obszar roboczy",
  'workspaceLoad.defaultError': "Nie można wczytać obszarów roboczych.",
  'workspaceLoad.projectsError': "Nie można wczytać projektów obszaru roboczego.",
  'workspaceLoad.emptyListError': "Odpowiedź listy obszarów roboczych nie zawierała żadnego obszaru.",
  'workspaceLoad.inviteSwitchError': "Nie można przełączyć na zaproszony obszar roboczy.",
