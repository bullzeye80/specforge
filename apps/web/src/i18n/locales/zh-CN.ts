...
export const zhCN: Dict = {
  ...
  'settings.kicker': '设置',
  'settings.title': '执行模式',
  'settings.subtitle': '在本机 CLI 与 BYOK 之间选择。这些凭据只保存在当前设备，不会共享给 workspace 成员。',
  ...
  'settings.apiHint': '请求会通过本机 daemon 代理发送到你设置的 Base URL。Key 只保存在当前设备，仅随提供方请求发送，不会共享给 workspace 成员。',
  ...
  'settings.mediaProvidersHint': '图片、视频、音频生成的 API key。存于当前设备，不属于 workspace 共享配置。',
  ...
  'connectors.subtitle': '当前设备上的个人数据连接。可为实时制品提供数据，但不会共享给 workspace。',
  ...
  'workspaceLoad.kicker': "工作区",
  'workspaceLoad.loadFailedTitle': "无法加载工作区",
  'workspaceLoad.refreshFailedTitle': "无法刷新工作区。",
  'workspaceLoad.retry': "重试",
  'workspaceLoad.retrying': "正在重试...",
  'workspaceLoad.personalFallback': "个人工作区",
  'workspaceLoad.defaultError': "无法加载工作区。",
  'workspaceLoad.projectsError': "无法加载工作区项目。",
  'workspaceLoad.emptyListError': "工作区列表响应中没有任何工作区。",
  'workspaceLoad.inviteSwitchError': "无法切换到受邀工作区。",
  ...
  'fileViewer.deployModalSubtitle': '使用所选平台账号部署当前 HTML 预览。平台 token 仅保存在本机设备，不会作为 workspace 配置共享。',
  ...
  'settings.connectorsClearConfirmBody': '删除密钥会断开此本地配置下所有的 Composio 连接器。已连接的账号、OAuth 授权和工具访问权限都将被一并移除。',
