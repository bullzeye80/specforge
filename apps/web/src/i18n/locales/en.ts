...
export const en: Dict = {
  ...
  'settings.subtitle': 'Choose Local CLI or BYOK. These credentials stay on this device and are not shared with workspace members.',
  ...
  'settings.apiHint': 'Calls are sent through the local daemon proxy to the base URL you set. The key stays on this device, is sent only with provider requests, and is not shared with workspace members.',
  ...
  'settings.mediaProvidersHint':
    'API keys for image, video, and audio generation. Stored locally for this device, not for the workspace.',
  ...
  'connectors.subtitle': 'Personal data connections for this device. They can power live artifacts, but they are not shared with the workspace.',
  ...
  'workspaceNav.switchAria': "Switch workspace: {name}",
  ...
  'workspaceLoad.kicker': "WORKSPACES",
  'workspaceLoad.loadFailedTitle': "Could not load workspaces",
  'workspaceLoad.refreshFailedTitle': "Could not refresh workspaces.",
  'workspaceLoad.retry': "Retry",
  'workspaceLoad.retrying': "Retrying...",
  'workspaceLoad.personalFallback': "Personal Workspace",
  'workspaceLoad.defaultError': "Could not load workspaces.",
  'workspaceLoad.projectsError': "Could not load workspace projects.",
  'workspaceLoad.emptyListError': "Workspace list response did not include any workspaces.",
  'workspaceLoad.inviteSwitchError': "Could not switch to the invited workspace.",
  'workspaceInvite.revokedTitle': "Invite link revoked",
  'workspaceInvite.revokedMessage': "This workspace invite was revoked by an admin or owner.",
  'workspaceInvite.expiredTitle': "Invite link expired",
  'workspaceInvite.expiredMessage': "Ask a workspace admin for a fresh invite link.",
  'workspaceInvite.usedTitle': "Invite link already used",
  'workspaceInvite.usedMessage': "This one-time invite has already been accepted. Ask a workspace admin for a new link.",
  'workspaceInvite.notFoundTitle': "Invite link not found",
  'workspaceInvite.returnAction': "Return to Open Design",
  'workspaceInvite.openWorkspaceAction': "Open workspace",
  'workspaceInvite.joinedSwitchFailedTitle': "Workspace joined",
  'workspaceInvite.joinedSwitchFailedMessage': "The invite was accepted, but Open Design could not switch to the workspace automatically.",
  'workspaceInvite.joiningTitle': "Joining workspace...",
  'workspaceInvite.joiningMessage': "We are accepting this invite and switching your workspace.",
  'workspaceInvite.joinedTitle': "Joined {name}",
  'workspaceInvite.joinedMessage': "You can continue using Open Design in this workspace.",
  'workspaceInvite.alreadyJoinedTitle': "Already in {name}",
  'workspaceInvite.alreadyJoinedMessage': "This invite was not consumed. You can keep working in this workspace.",
  ...
  'workspaceSettings.roleOwner': "Owner",
  'workspaceSettings.roleAdmin': "Admin",
  'workspaceSettings.roleMember': "Member",
  'workspaceSettings.loadingAccess': "Loading access",
  'workspaceSettings.capabilityPersonal': "Personal workspace: create projects and start a team workspace when you need collaboration.",
  'workspaceSettings.capabilityOwner': "Owner: manage members, invites, viewer links, project moves, lifecycle, and ownership.",
  'workspaceSettings.capabilityAdmin': "Admin: manage members, invites, viewer links, and project moves.",
  'workspaceSettings.capabilityMember': "Member: create and open workspace projects. Ask an admin for invites, viewer links, or management changes.",
  'workspaceSettings.capabilityNoAccess': "You do not have access to manage this workspace.",
  'workspaceSettings.adminOwnerRequired': "Admin or owner access required.",
  'workspaceSettings.ownerRequired': "Owner access required.",
  'workspaceSettings.viewerLinksManagerRequired': "Admin or owner access required to view, copy, or revoke external viewer links.",
  'workspaceSettings.accessAria': "Workspace access",
  'workspaceSettings.loadStatusAria': "Workspace load status",
  'workspaceSettings.detailsUnavailable': "Workspace details unavailable",
  'workspaceSettings.retry': "Retry",
  'workspaceSettings.statusAria': "Workspace status",
  'workspaceSettings.statusMembers': "Members",
  'workspaceSettings.statusProjects': "Projects",
  'workspaceSettings.statusAutomations': "Automations",
  'workspaceSettings.statusPendingInvites': "Pending invites",
  'workspaceSettings.statusViewerLinks': "Viewer links",
  'workspaceSettings.noOwnerLoaded': "No owner loaded",
  'workspaceSettings.detailsTitle': "Workspace details",
  'workspaceSettings.detailsTeamBody': "Rename the team workspace that projects and invites belong to.",
  'workspaceSettings.detailsPersonalBody': "Your personal workspace stays available without account setup.",
  'workspaceSettings.personalNameFixed': "Personal workspace names stay fixed.",
  'workspaceSettings.workspaceNamePlaceholder': "Workspace name",
  'workspaceSettings.saving': "Saving...",
  'workspaceSettings.createTitle': "Create workspace",
  'workspaceSettings.createBody': "Start another team workspace without forcing account registration.",
  'workspaceSettings.creating': "Creating...",
  'workspaceSettings.membersTitle': "Members",
  'workspaceSettings.membersBody': "Members can open projects in this workspace. Admins can invite and manage members.",
  'workspaceSettings.loadingMembers': "Loading members...",
  'workspaceSettings.ownerRoleLocked': "Transfer ownership to change this role.",
  'workspaceSettings.transferAssetsAria': "Transfer assets for {member}",
  'workspaceSettings.assetsToMember': "Assets to {member}",
  'workspaceSettings.removing': "Removing...",
  'workspaceSettings.remove': "Remove",
  'workspaceSettings.askAdminChangeAccess': "Ask another admin to change your access.",
  'workspaceSettings.ownershipTitle': "Ownership",
  'workspaceSettings.ownershipBody': "Transfer owner before the current owner leaves the workspace.",
  'workspaceSettings.personalOwnershipLocked': "Personal workspace ownership cannot be transferred.",
  'workspaceSettings.inviteBeforeTransferOwner': "Invite another member before transferring ownership.",
  'workspaceSettings.transferring': "Transferring...",
  'workspaceSettings.transferOwner': "Transfer owner",
  'workspaceSettings.invitesTitle': "Invites",
  'workspaceSettings.invitesBody': "Invite links let anonymous or signed-in users join this workspace.",
  'workspaceSettings.personalNoInvites': "Personal workspace does not accept invite links.",
  'workspaceSettings.inviteRoleAria': "Invite role",
  'workspaceSettings.inviteExpiryAria': "Invite expiry",
  'workspaceSettings.dayOption': "{days} day",
  'workspaceSettings.daysOption': "{days} days",
  'workspaceSettings.creatingInvite': "Creating invite...",
  'workspaceSettings.createInvite': "Create invite",
  'workspaceSettings.hideHistory': "Hide history",
  'workspaceSettings.showHistory': "Show history ({count})",
  'workspaceSettings.invitesManagerOnly': "Only admins and owners can view or create invite links.",
  'workspaceSettings.noInvites': "No invites yet.",
  'workspaceSettings.noActiveInvites': "No active invite links. Show history to review accepted, expired, or revoked invites.",
  'workspaceSettings.copy': "Copy",
  'workspaceSettings.revoking': "Revoking...",
  'workspaceSettings.revoke': "Revoke",
  'workspaceSettings.viewerLinksTitle': "Viewer links",
  'workspaceSettings.viewerLinksBody': "External viewer links grant read-only access to one artifact, not the workspace.",
  'workspaceSettings.viewerLinksManagerOnly': "Only admins and owners can view external viewer links.",
  'workspaceSettings.noViewerLinks': "No external viewer links yet.",
  'workspaceSettings.projectsTitle': "Projects",
  'workspaceSettings.projectsBody': "Move projects to another workspace before deleting this workspace.",
  'workspaceSettings.noProjects': "No projects in this workspace.",
  'workspaceSettings.ownedBy': "owned by {user}",
  'workspaceSettings.createdBy': "created by {user}",
  'workspaceSettings.createdAt': "created {time}",
  'workspaceSettings.expiresAt': "expires {time}",
  'workspaceSettings.revokedAt': "revoked {time}",
  'workspaceSettings.acceptedBy': "accepted by {user}",
  'workspaceSettings.transferProjectOwnerAria': "Transfer owner for {project}",
  'workspaceSettings.ownerOption': "Owner: {member}",
  'workspaceSettings.transfer': "Transfer",
  'workspaceSettings.moveProjectAria': "Move {project}",
  'workspaceSettings.moveToPlaceholder': "Move to...",
  'workspaceSettings.moving': "Moving...",
  'workspaceSettings.move': "Move",
  'workspaceSettings.lifecycleTitle': "Workspace lifecycle",
  'workspaceSettings.lifecycleBody': "Leave a team workspace, or delete an empty team workspace when you own it.",
  'workspaceSettings.personalCannotLeaveDelete': "Personal workspace cannot be left or deleted.",
  'workspaceSettings.transferBeforeLeaving': "Transfer ownership before leaving this workspace.",
  'workspaceSettings.moveProjectsBeforeDelete': "Move or delete all workspace projects before deleting the workspace.",
  'workspaceSettings.deleteAutomationsBeforeDelete': "Delete all workspace automations before deleting the workspace.",
  'workspaceSettings.leaving': "Leaving...",
  'workspaceSettings.leave': "Leave",
  'workspaceSettings.deleting': "Deleting...",
  'workspaceSettings.activityTitle': "Activity",
  'workspaceSettings.activityBody': "Recent workspace actions across invites, members, projects, and viewer links.",
  'workspaceSettings.noActivity': "No workspace activity yet.",
  'workspaceSettings.detailsLoadError': "Could not load workspace details. {error}",
  'workspaceSettings.viewerLinksLoadError': "Could not load viewer links. {error}",
  'workspaceSettings.invitesLoadError': "Could not load workspace invites. {error}",
  'workspaceSettings.workspaceCreatedNotice': "Created {name}.",
  'workspaceSettings.workspaceRenamedNotice': "Workspace renamed.",
  'workspaceSettings.leaveConfirm': "Leave {name}? {impact}",
  'workspaceSettings.leftNotice': "Left {name}.",
  'workspaceSettings.deleteConfirm': "Delete {name}? {impact}",
  'workspaceSettings.deletedNotice': "Deleted {name}.",
  'workspaceSettings.adminInviteConfirm': "Create admin invite? {impact}",
  'workspaceSettings.inviteCreateFailed': "Could not create invite link.",
  'workspaceSettings.inviteCopied': "Invite link copied.",
  'workspaceSettings.roleChangeConfirm': "Change {user} to {role}? {impact}",
  'workspaceSettings.transferOwnershipConfirm': "Transfer ownership? {impact}",
  'workspaceSettings.ownershipTransferredNotice': "Workspace ownership transferred.",
  'workspaceSettings.chooseTransferTargetNotice': "Choose a workspace member to receive this member's projects and routines.",
  'workspaceSettings.thisWorkspace': "this workspace",
  'workspaceSettings.removeMemberConfirm': "Remove {user} from {workspace}? {impact}",
  'workspaceSettings.revokeInviteConfirm': "Revoke invite link? {impact}",
  'workspaceSettings.onlyPendingInviteCopy': "Only pending invite links can be copied.",
  'workspaceSettings.noInviteLink': "No invite link available.",
  'workspaceSettings.revokeViewerLinkConfirm': "Revoke viewer link? {impact}",
  'workspaceSettings.viewerLinkRevokedNotice': "Viewer link revoked.",
  'workspaceSettings.viewerLinkCopied': "Viewer link copied.",
  'workspaceSettings.noViewerLink': "No viewer link available.",
  'workspaceSettings.moveProjectConfirm': "Move {project}? {impact}",
  'workspaceSettings.projectMovedNotice': "Moved {project}.",
  'workspaceSettings.transferProjectOwnerConfirm': "Transfer {project} owner? {impact}",
  'workspaceSettings.projectOwnerTransferredNotice': "Transferred {project} owner.",
  'workspaceSettings.you': "You",
  'workspaceSettings.viewerRole': "viewer",
  'workspaceSettings.inviteLink': "Invite link",
  'workspaceSettings.inviteAccepted': "Invite accepted",
  'workspaceSettings.inviteRevoked': "Invite revoked",
  'workspaceSettings.inviteExpired': "Invite expired",
  'workspaceSettings.ownsAssets': "owns {items}",
  'workspaceSettings.joinedAt': "joined {time}",
  'workspaceSettings.joinList': "{head} and {tail}",
  'workspaceSettings.projectSingular': "project",
  'workspaceSettings.projectPlural': "projects",
  'workspaceSettings.routineSingular': "routine",
  'workspaceSettings.routinePlural': "routines",
  'workspaceSettings.viewerLinkSingular': "viewer link",
  'workspaceSettings.viewerLinkPlural': "viewer links",
  'workspaceSettings.inviteSingular': "invite",
  'workspaceSettings.invitePlural': "invites",
  'workspaceSettings.deploymentSingular': "deployment",
  'workspaceSettings.deploymentPlural': "deployments",
  'workspaceSettings.memberRecordSingular': "member record",
  'workspaceSettings.memberRecordPlural': "member records",
  'workspaceSettings.pendingInviteSingular': "pending invite",
  'workspaceSettings.pendingInvitePlural': "pending invites",
  'workspaceSettings.activityHistory': "activity history",
  'workspaceSettings.memberFallback': "member",
  'workspaceSettings.projectFallback': "project",
  'workspaceSettings.artifactFallback': "artifact",
  'workspaceSettings.newNameFallback': "new name",
  'workspaceSettings.leaveImpactNoAssets': "You will lose access until someone invites you again.",
  'workspaceSettings.leaveImpact': "You will lose access, and your {items} will transfer. Pending invites and viewer links you created will be revoked.",
  'workspaceSettings.leaveImpactWithRecipient': "You will lose access, and your {items} will transfer to {user}. Pending invites and viewer links you created will be revoked.",
  'workspaceSettings.removeMemberImpactNoAssets': "They will lose access. Pending invites and viewer links they created will be revoked.",
  'workspaceSettings.removeMemberImpact': "They will lose access. Their {items} will transfer to {user}. Pending invites and viewer links they created will be revoked.",
  'workspaceSettings.roleChangeToAdminImpact': "{user} will be able to manage members, invites, viewer links, and project ownership in this workspace.",
  'workspaceSettings.roleChangeToMemberImpact': "{user} will lose workspace management access. Pending invites and viewer links they created will be revoked.",
  'workspaceSettings.adminInviteImpact': "Anyone with this link can join {workspace} as an admin. They will be able to manage members, invites, viewer links, project moves, and project ownership.",
  'workspaceSettings.adminInviteImpactWithExpiry': "Anyone with this link can join {workspace} as an admin for {days} days. They will be able to manage members, invites, viewer links, project moves, and project ownership.",
  'workspaceSettings.transferWorkspaceOwnerImpact': "{user} will become the only owner of {workspace}. You will become an admin and lose owner-only actions like deleting the workspace or transferring ownership again.",
  'workspaceSettings.moveProjectImpact': "{project} will move to {workspace}. Existing deployments and viewer links stay attached to the project and move with it.",
  'workspaceSettings.transferProjectOwnerImpact': "{project} will stay in this workspace, but {user} will become responsible for it.",
  'workspaceSettings.revokeInviteImpact': "This {role} invite link will stop letting new people join. Existing workspace members are not affected.",
  'workspaceSettings.revokeViewerLinkImpact': "External viewers will lose access to {target}. The artifact itself stays in the workspace.",
  'workspaceSettings.revokeViewerLinkImpactWithArtifact': "External viewers will lose access to {target} for {artifact}. The artifact itself stays in the workspace.",
  'workspaceSettings.deleteWorkspaceImpact': "Deleting this workspace removes {items}. It can only proceed after projects and automations are gone.",
  'workspaceSettings.cleanupRevoked': "revoked {items}",
  'workspaceSettings.cleanupTransferred': "transferred {items}",
  'workspaceSettings.cleanupTransferredTo': "transferred {items} to {user}",
  'workspaceSettings.cleanupStillOwned': "{items} still owned",
  'workspaceSettings.activityWorkspaceCreated': "Created workspace",
  'workspaceSettings.activityWorkspaceRenamed': "Renamed workspace to {name}",
  'workspaceSettings.activityMemberLeft': "Left workspace",
  'workspaceSettings.activityMemberRemoved': "Removed member",
  'workspaceSettings.activityRoleUpdated': "Changed member role to {role}",
  'workspaceSettings.activityOwnerTransferred': "Transferred owner to {user}",
  'workspaceSettings.activityInviteCreated': "Created {role} invite",
  'workspaceSettings.activityInviteRevoked': "Revoked {role}invite",
  'workspaceSettings.activityInviteAccepted': "Accepted invite as {role}",
  'workspaceSettings.activityProjectCreated': "Created {project}",
  'workspaceSettings.activityProjectCreatedFrom': "Created {project} from {source}",
  'workspaceSettings.activityProjectDeleted': "Deleted {project}",
  'workspaceSettings.activityProjectImported': "Imported {project}",
  'workspaceSettings.activityProjectImportedFrom': "Imported {project} from {source}",
  'workspaceSettings.activityProjectMoved': "Moved {project}",
  'workspaceSettings.activityProjectMovedWith': "Moved {project} with {resources}",
  'workspaceSettings.activityProjectOwnerTransferred': "Transferred {project} owner to {user}",
  'workspaceSettings.activityRoutineCreated': "Created routine {routine}",
  'workspaceSettings.activityRoutineUpdated': "Updated routine {routine}",
  'workspaceSettings.activityRoutineDeleted': "Deleted routine {routine}",
  'workspaceSettings.activityRoutineOwnerTransferred': "Transferred routine {routine} owner to {user}",
  'workspaceSettings.activityRoutineRun': "Ran routine {routine}",
  'workspaceSettings.activityShareCreated': "Created viewer link for {project}",
  'workspaceSettings.activityShareRevoked': "Revoked viewer link for {project}",
  'workspaceSettings.activityShareRevokedProjectDeleted': "Revoked viewer link because {project} was deleted",
  'workspaceSettings.activityShareRevokedArtifactDeleted': "Revoked viewer link because {artifact} was deleted",
  ...
  'fileViewer.deployModalSubtitle': 'Use the selected provider account to deploy this HTML preview. Provider tokens stay on this device and are not shared with the workspace.',
  ...
  'settings.connectorsClearConfirmBody': 'Removing the key disconnects every Composio connector linked to this local profile. Connected accounts, OAuth grants, and tool access will all be removed.',
