...
export const fa: Dict = {
  ...
  'workspaceLoad.kicker': "فضاهای کاری",
  'workspaceLoad.loadFailedTitle': "فضاهای کاری بارگیری نشدند",
  'workspaceLoad.refreshFailedTitle': "فضاهای کاری به‌روزرسانی نشدند.",
  'workspaceLoad.retry': "تلاش دوباره",
  'workspaceLoad.retrying': "در حال تلاش دوباره...",
  'workspaceLoad.personalFallback': "فضای کاری شخصی",
  'workspaceLoad.defaultError': "فضاهای کاری بارگیری نشدند.",
  'workspaceLoad.projectsError': "پروژه‌های فضای کاری بارگیری نشدند.",
  'workspaceLoad.emptyListError': "پاسخ فهرست فضاهای کاری هیچ فضای کاری نداشت.",
  'workspaceLoad.inviteSwitchError': "امکان جابه‌جایی به فضای کاری دعوت‌شده وجود نداشت.",
