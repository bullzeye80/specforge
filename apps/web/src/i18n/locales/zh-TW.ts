...
export const zhTW: Dict = {
  ...
  'workspaceLoad.kicker': "工作區",
  'workspaceLoad.loadFailedTitle': "無法載入工作區",
  'workspaceLoad.refreshFailedTitle': "無法重新整理工作區。",
  'workspaceLoad.retry': "重試",
  'workspaceLoad.retrying': "正在重試...",
  'workspaceLoad.personalFallback': "個人工作區",
  'workspaceLoad.defaultError': "無法載入工作區。",
  'workspaceLoad.projectsError': "無法載入工作區專案。",
  'workspaceLoad.emptyListError': "工作區清單回應中沒有任何工作區。",
  'workspaceLoad.inviteSwitchError': "無法切換到受邀工作區。",
