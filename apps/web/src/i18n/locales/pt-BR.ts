...
export const ptBR: Dict = {
  ...
  'workspaceLoad.kicker': "ESPAÇOS DE TRABALHO",
  'workspaceLoad.loadFailedTitle': "Não foi possível carregar os espaços de trabalho",
  'workspaceLoad.refreshFailedTitle': "Não foi possível atualizar os espaços de trabalho.",
  'workspaceLoad.retry': "Tentar novamente",
  'workspaceLoad.retrying': "Tentando novamente...",
  'workspaceLoad.personalFallback': "Espaço de trabalho pessoal",
  'workspaceLoad.defaultError': "Não foi possível carregar os espaços de trabalho.",
  'workspaceLoad.projectsError': "Não foi possível carregar os projetos do espaço de trabalho.",
  'workspaceLoad.emptyListError': "A resposta da lista de espaços de trabalho não incluiu nenhum espaço.",
  'workspaceLoad.inviteSwitchError': "Não foi possível alternar para o espaço de trabalho convidado.",
