...
export const ja: Dict = {
  ...
  'workspaceLoad.kicker': "ワークスペース",
  'workspaceLoad.loadFailedTitle': "ワークスペースを読み込めませんでした",
  'workspaceLoad.refreshFailedTitle': "ワークスペースを更新できませんでした。",
  'workspaceLoad.retry': "再試行",
  'workspaceLoad.retrying': "再試行中...",
  'workspaceLoad.personalFallback': "個人ワークスペース",
  'workspaceLoad.defaultError': "ワークスペースを読み込めませんでした。",
  'workspaceLoad.projectsError': "ワークスペースのプロジェクトを読み込めませんでした。",
  'workspaceLoad.emptyListError': "ワークスペース一覧の応答にワークスペースが含まれていません。",
  'workspaceLoad.inviteSwitchError': "招待されたワークスペースに切り替えられませんでした。",
