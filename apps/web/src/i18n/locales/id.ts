...
export const id: Dict = {
  ...
  'workspaceLoad.kicker': "RUANG KERJA",
  'workspaceLoad.loadFailedTitle': "Tidak dapat memuat ruang kerja",
  'workspaceLoad.refreshFailedTitle': "Tidak dapat menyegarkan ruang kerja.",
  'workspaceLoad.retry': "Coba lagi",
  'workspaceLoad.retrying': "Mencoba lagi...",
  'workspaceLoad.personalFallback': "Ruang kerja pribadi",
  'workspaceLoad.defaultError': "Tidak dapat memuat ruang kerja.",
  'workspaceLoad.projectsError': "Tidak dapat memuat proyek ruang kerja.",
  'workspaceLoad.emptyListError': "Respons daftar ruang kerja tidak menyertakan ruang kerja apa pun.",
  'workspaceLoad.inviteSwitchError': "Tidak dapat beralih ke ruang kerja undangan.",
