...
export const ru: Dict = {
  ...
  'workspaceLoad.kicker': "РАБОЧИЕ ПРОСТРАНСТВА",
  'workspaceLoad.loadFailedTitle': "Не удалось загрузить рабочие пространства",
  'workspaceLoad.refreshFailedTitle': "Не удалось обновить рабочие пространства.",
  'workspaceLoad.retry': "Повторить",
  'workspaceLoad.retrying': "Повторная попытка...",
  'workspaceLoad.personalFallback': "Личное рабочее пространство",
  'workspaceLoad.defaultError': "Не удалось загрузить рабочие пространства.",
  'workspaceLoad.projectsError': "Не удалось загрузить проекты рабочего пространства.",
  'workspaceLoad.emptyListError': "Ответ со списком рабочих пространств не содержал ни одного пространства.",
  'workspaceLoad.inviteSwitchError': "Не удалось переключиться на приглашенное рабочее пространство.",
