...
export const ko: Dict = {
  ...
  'workspaceLoad.kicker': "작업 공간",
  'workspaceLoad.loadFailedTitle': "작업 공간을 불러올 수 없습니다",
  'workspaceLoad.refreshFailedTitle': "작업 공간을 새로 고칠 수 없습니다.",
  'workspaceLoad.retry': "다시 시도",
  'workspaceLoad.retrying': "다시 시도 중...",
  'workspaceLoad.personalFallback': "개인 작업 공간",
  'workspaceLoad.defaultError': "작업 공간을 불러올 수 없습니다.",
  'workspaceLoad.projectsError': "작업 공간 프로젝트를 불러올 수 없습니다.",
  'workspaceLoad.emptyListError': "작업 공간 목록 응답에 작업 공간이 포함되지 않았습니다.",
  'workspaceLoad.inviteSwitchError': "초대된 작업 공간으로 전환할 수 없습니다.",
